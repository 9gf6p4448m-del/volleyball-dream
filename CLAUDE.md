...
- **Phase 3 已結案**（2026-07-26，**權威快照＝`docs/phase3-w8-status.md`**）：W1–W8 全交付
  ...
  體感 OK，難度題關卷）。
- **Phase 4 進行中**（憲法＝`docs/phase4-decisions-RESOLVED.md`）：W1 時間系統已結案
  （`docs/phase4-w1-status.md`，423 測綠）；W2 身高創角＋成長曲線＋儀式演出層已結案
  （**權威快照＝`docs/phase4-w2-status.md`**，439 測綠、平衡主錨改 175）。W3 起：
  位置玩法工程／轉位事件／第 3 屆手寫新生／演出框架接入畢業與來投。
