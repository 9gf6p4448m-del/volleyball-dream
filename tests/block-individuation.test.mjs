...
// 門檻取 0.5%（＝現值的約 1/3、絕對事件數 5/1022）：
//   ‧ 留餘裕：16 → 5 還有 3 倍空間，人格／時序的日常微調不會誤報
//   ‧ 抓得到：同步線一加回來就是 0/1022，離門檻整整 5 個事件
//   ‧ 分得開：p=0.0157、n=1022 ⇒ SE 0.39pp，門檻與 0 相距 1.3 SE 以上
// 分母門檻 800 ＝ 現值 1022 的保守下界，確保「這個量測位置真的分得出有無」
//（02 §6.1 條 5：樣本不足時數字本身沒有意義）。
