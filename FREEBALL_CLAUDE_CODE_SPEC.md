# 《排球夢》Free Ball 街機物理手感重構白皮書（歷史提案）
> 2026-09-24：本文保留作為沙盒設計歷史，不再是實作權威。直接操作改造以 `docs/DIRECT_PLAY_BLUEPRINT.md` 為準。文中的競品倍率、零磁吸、2508 測試與吊球待修主張已有未查證或過時項目，不得照抄當成現況。
> 以下內容是當時提案的原文紀錄；內含 Master Prompt 也已停用，不能再當作當前待辦或權威規格。
