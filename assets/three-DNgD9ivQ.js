...
#define LOW_PRECISION`),e}function L_(s){let e="SHADOWMAP_TYPE_BASIC";return s.shadowMapType===$c?e="SHADOWMAP_TYPE_PCF":s.shadowMapType===th?e="SHADOWMAP_TYPE_PCF_SOFT":s.shadowMapType===gn&&(e="SHADOWMAP_TYPE_VSM"),e}function D_(s){let e="ENVMAP_TYPE_CUBE";if(s.envMap)switch(s.envMapMode){case Li:case Di:e="ENVMAP_TYPE_CUBE";break;case dr:e="ENVMAP_TYPE_CUBE_UV";break}return e}function U_(s){let e="ENVMAP_MODE_REFLECTION";return s.envMap&&s.envMapMode===Di&&(e="ENVMAP_MODE_REFRACTION"),e}function N_(s){let e="ENVMAP_BLENDING_NONE";if(s.envMap)switch(s.combine){case Jc:e="ENVMAP_BLENDING_MULTIPLY";break;case Mh:e="ENVMAP_BLENDING_MIX";break;case yh:e="ENVMAP_BLENDING_ADD";break}return e}function F_(s){const e=s.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:n,maxMip:t}}function O_(s,e,t,n){const i=s.getContext(),r=t.defines;let o=t.vertexShader,a=t.fragmentShader;const c=L_(t),l=D_(t),h=U_(t),u=N_(t),d=F_(t),p=T_(t),_=b_(r),g=i.createProgram();let m,f,E=t.glslVersion?"#version "+t.glslVersion+`
