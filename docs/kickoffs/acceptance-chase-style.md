> ★ 2026-08-28 部分取代 ★ 本檔「第二層並列飄·名／跳·名變體」的規格已由 Sawmah
> 08-28 拍板的甲案取代（試玩抓出兩層面板重複：追發層落點＝後排三人站的深區，
> 式×人全展開兩層合計 21 顆鈕）。新規格＝式為主面板切換鈕、追發層純選人＋體力標記；
> 「gate 在行為層」「tap 到底 style/aim 成對」兩條驗收精神原樣保留，
> 測試改寫於 tests/uni-tech-panel.test.mjs 08-28 區段。
