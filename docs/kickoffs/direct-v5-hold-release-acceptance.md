...
- **2026-09-25 整份由使用者裁定退場**：真機試玩「球都起不來」，實測是放開才出手讓點擊停留時間變成延遲（見 `direct-v5-press-receive-acceptance.md`）。使用者選方案 1，恢復按下即出手；本檔 A19a／b／c／e／f 與 A7、A3b 的修改一併退場，A19d 的扣球部分與覆審補的 lostpointercapture、heldPassType 保留。
