...
//     修訂（2026-07-30 裁定，convergence.md §5.10）：0.48 → 0.43。
//     0.48 與 §1.3 接球半徑 0.38H 在 t=1 矛盾（最低可及球心 0.10H > 球半徑 0.105
//     ⇒ 貼地球構不到，v4 §2.2 承諾破裂）；0.43 使 0.05H ≤ 0.105 對 H ≤ 2.1 成立。
//
...
export const RECEIVE_HANDPOINT_H_RATIO = 0.43;
...
export function reachVolumeFor({
  ...
  //   接球（含防守低球）→ 0.43 × H（前臂平台接觸點；2026-07-30 裁定自 0.48 下修，見常數區）
  //   舉球 → 1.03 × H（額前上方觸球點）
