...
export const TUNING = {
  ...
  // ★ 2026-08-31 重定（觸網上線後帳本重算）★ 真實感卷批3「觸網只掛壓手」讓壓手
  // 多了第三項代價，1.6/0.7 的全樣本淨值從 −1.1pp（雜訊內）掉到 −3.1pp（顯著）
  // ＝賭局變成明虧。照 08-24 動手前凍結的同一判準（「全樣本最接近 0 或略負、
  // top 仍顯著為正」）用同一工具重掃（1907 配對接觸點）：唯一達標組＝1.30/0.85
  // （全 −0.9±3.1 雜訊內、top +24.3±5.8 顯著）。
  BLOCK_PRESS_SIDE_MUL: 1.3,
  BLOCK_PRESS_BODY_MUL: 0.85,
