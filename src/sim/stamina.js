...
export const STAMINA = {
  ...
  // **疊在 COST_SPIKE 之上**（一次變向扣球總價 0.040 ≈ 2.2 顆普通扣球、3 次跳攔）。
  // 出廠自訂值（未經治具校準）：量級目標＝連用會把攻擊手在一局內推進重度檔
  //（重度檔本身就是「使不出來」的閘），真人試玩後再調
  COST_SPIKE_TWIST: 0.022, // 二段變向（空中扭腰改揮）——體力燒得兇是這招的代價本體
