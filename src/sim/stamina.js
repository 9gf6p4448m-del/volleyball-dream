...
export const STAMINA = {
  ...
  // 批 4c 二段時間差（acceptance-pro-batch4c.md F2-2）：空中二次發力的額外消耗，
  // **疊在 COST_SPIKE 之上**（一次變向扣球總價 0.029 ≈ 1.6 顆普通扣球、2.2 次跳攔）。
  // 拍板丙（2026-08-26 純幾何降級）：機率騙牆層已刪、變向收益回歸純幾何，
  // 代價同步降輕——0.022 減半為 0.011（提案值，未經真人試玩校準）
  COST_SPIKE_TWIST: 0.011, // 二段變向（空中扭腰改揮）——代價之二（之一＝飛行時間折損）
