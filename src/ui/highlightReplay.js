...
//   · 全版 6000：中位球（5.3s）「決定性一拍→落地」整段吃得下，還帶到舉球→扣球
//     的鋪陳；最長飛行截尾 6 秒（08-27 試玩回饋「時長不夠長、很短暫就過去了」，
//     自 3500 上調）
//   · 短版 2500：看見自己怎麼輸的，但不逗留（kickoff 拍板 1；同回饋自 1400 上調）
// 兩者皆 >0 且短版真的比全版短（HR-3）。
export const HIGHLIGHT_FULL_MS = 6000;
export const HIGHLIGHT_SHORT_MS = 2500;
